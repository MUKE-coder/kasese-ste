export function sendAdminNotificationEmail(clientData: {
  ...
  return `
      ...
      <head>
          ...
          <title>New Client Inquiry - Desishub</title>
          <style>
      ...
      <body>
          ...
          <div class="footer">
              <p>© ${new Date().getFullYear()} Desishub. All rights reserved.</p>
          </div>
      </body>
      </html>
    `;
...
export function sendClientConfirmationEmail(
  ...
  return `
      ...
      <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Thank You for Your Inquiry - Desishub</title>
          <style>
              body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
              .header { background-color: #1e40af; color: white; padding: 20px; }
      ...
      <body>
          <div class="header">
              <div class="header-content">
                  <img src="https://utfs.io/f/HLxTbDBCDLwfU1orETHlbxM69AvE1HPOaYKR4rqd8ygiztfm" alt="Enerwat Logo" class="developer-image">
                  <div class="developer-info">
                      <h2>Enerwat Egineering Limited</h2>
          ...
          <div class="footer">
              <p>© ${new Date().getFullYear()} Enerwat. All rights reserved.</p>
              <p>Questions? Contact us at info@enerwat.com</p>
              <p>
